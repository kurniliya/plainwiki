...
<x:x x="{" m="0em"  stretch="true" top="м" middle="н" extend="п" bottom="о">{</x:x>
<x:x x="}" m="0em"  stretch="true" top="ь" middle="э" extend="ъ" bottom="ю">{</x:x>

<x:x x="(" m="0em"  stretch="true" top="ж" middle="з" extend="з" bottom="и">(</x:x>
<x:x x=")" m="0em"  stretch="true" top="ц" middle="ч" extend="ч" bottom="ш">)</x:x>

<x:x x="[" m="0em"  stretch="true" top="й" middle="к" extend="к" bottom="л">[</x:x>
<x:x x="]" m="0em"  stretch="true" top="щ" middle="ъ" extend="ъ" bottom="ы">]</x:x>

<x:x x="&#x301A;" m="0em"  stretch="true" top="йй" middle="кк" extend="кк" bottom="лл">[[</x:x>
<x:x x="&#x301B;" m="0em"  stretch="true" top="щщ" middle="ъъ" extend="ъъ" bottom="ыы">]]</x:x>

<x:x x="|" m="0em"  stretch="true" top="з" middle="з" extend="з" bottom="з">|</x:x>
<x:x x="||" m="0em"  stretch="true" top="зз" middle="зз" extend="зз" bottom="зз">||</x:x>
